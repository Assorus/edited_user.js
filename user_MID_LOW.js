 ...
 * [TEST] https://addons.mozilla.org/about ***/
   // user_pref("intl.accept_languages", "en-US, en"); //EDITED COMMENTED
/* 0211: use en-US locale regardless of the system or region locale
 * [SETUP-WEB] May break some input methods e.g xim/ibus for CJK languages [1]
 * [TEST] https://arkenfox.github.io/TZP/tests/formatting.html
 * [1] https://bugzilla.mozilla.org/buglist.cgi?bug_id=867501,1629630 ***/
   // user_pref("javascript.use_us_english_locale", true); // [HIDDEN PREF] //EDITED COMMENTED
 ...
 * [SETUP-CHROME] Override this if you trust and use a privacy respecting search engine ***/
   // user_pref("keyword.enabled", false); //EDITED COMMENTED
...
user_pref("browser.sessionstore.privacy_level", 1);//EDITED DEFAULT_VALUE=2
...
user_pref("browser.shell.shortcutFavicons", true);//EDITED DEFAULT_VALUE=false
...
user_pref("network.http.referer.XOriginTrimmingPolicy", 0); //EDITED DEFAULT_VALUE=2
...
user_pref("media.autoplay.blocking_policy", 1); //EDITED DEFAULT_VALUE=2
...
user_pref("privacy.clearOnShutdown.offlineApps", false); // [DEFAULT: false] //UNCERTAIN
user_pref("privacy.clearOnShutdown.cookies", true); 
user_pref("privacy.clearOnShutdown.siteSettings", false); // [DEFAULT: false] //EDITED UNCERTAIN UNCOMMENTED
...
user_pref("privacy.resistFingerprinting.letterboxing", false); // [HIDDEN PREF] //IMPORTANT
