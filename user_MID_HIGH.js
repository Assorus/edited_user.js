...
user_pref("browser.search.region", "US"); // [HIDDEN PREF] //EDITED UNCOMMENTED
...
user_pref("browser.safebrowsing.downloads.enabled", false); //EDITED UNCOMMENTED IMPORTANT
...
user_pref("browser.safebrowsing.downloads.remote.block_potentially_unwanted", false); //EDITED UNCOMMENTED
user_pref("browser.safebrowsing.downloads.remote.block_uncommon", false); //EDITED UNCOMMENTED
...
user_pref("browser.send_pings", false); // [DEFAULT: false] //EDITED UNCOMMENTED
...
user_pref("network.dns.disableIPv6", true); //IMPORTANT 
/* 0702: set the proxy server to do any DNS lookups when using SOCKS
 * e.g. in Tor, this stops your local DNS server from knowing your Tor destination
 * as a remote Tor node will handle the DNS request
 * [1] https://trac.torproject.org/projects/tor/wiki/doc/TorifyHOWTO/WebBrowsers ***/
   // user_pref("network.proxy.socks_remote_dns", true); //EDITED COMMENTED
/* 0703: disable using UNC (Uniform Naming Convention) paths [FF61+]
 * [SETUP-CHROME] Can break extensions for profiles on network shares
 * [1] https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/26424 ***/
user_pref("network.file.disable_unc_paths", true); // [HIDDEN PREF] //IMPORTANT
 ...
 * [1] https://blog.mozilla.org/security/2021/10/25/securing-the-proxy-api-for-firefox-add-ons/ ***/
   // user_pref("network.proxy.failover_direct", false); // IMPORTANT
 ...
 * [1] https://bugzilla.mozilla.org/buglist.cgi?bug_id=1732792,1733994,1733481 ***/
   // user_pref("network.proxy.allow_bypass", false); // [HIDDEN PREF FF95-96] //IMPORTANT
...
user_pref("network.trr.mode", 3); //EDITED UNCOMMENTED DEFAULT_VALUE=5
...
user_pref("browser.urlbar.suggest.engines", false); //UNCERTAIN
...
user_pref("layout.css.visited_links_enabled", false); //IMPORTANT
...
user_pref("browser.cache.disk.enable", false); //UNCERTAIN IMPORTANT
...
user_pref("security.ssl.require_safe_negotiation", true);//VERY IMPORTANT MAY AFFECT SPEED
...
user_pref("security.OCSP.enabled", 1); // [DEFAULT: 1]//IMORTANT
...
user_pref("security.OCSP.require", true);//IMPORTANT MAY AFFECT CONNECTION
...
user_pref("security.cert_pinning.enforcement_level", 2); //IMPORTANT
...
user_pref("dom.security.https_only_mode_send_http_background_request", false); //IMPORTANT MAY AFFECT SPEED OR LOADING
...
user_pref("layout.css.font-visibility.standard", 1); //EDITED UNCOMMENTED
user_pref("layout.css.font-visibility.trackingprotection", 1); //EDITED UNCOMMETED
...
user_pref("network.http.referer.XOriginPolicy", 1); //EDITED DEFAULT_VALUE=2
/* 1602: control the amount of cross-origin information to send [FF52+]
 * 0=send full URI (default), 1=scheme+host+port+path, 2=scheme+host+port ***/
user_pref("network.http.referer.XOriginTrimmingPolicy", 1); //EDITED DEFAULT_VALUE=2
...
user_pref("media.peerconnection.enabled", false); //UNCERTAIN UBLOCK ORIGIN DOES THE JOB
...
user_pref("media.peerconnection.ice.no_host", true); //UNCERTAIN IMPORTANT
/* 2020: disable GMP (Gecko Media Plugins)
 * [1] https://wiki.mozilla.org/GeckoMediaPlugins ***/
user_pref("media.gmp-provider.enabled", false); //EDITED UNCOMMETED
...
user_pref("media.eme.enabled", false); //IMPORTANT
...
user_pref("media.autoplay.blocking_policy", 2); //EDITED DEFAULT_VALUE=2
...
user_pref("dom.disable_beforeunload", true); //NOTICEABLE
/* 2402: prevent scripts from moving and resizing open windows ***/
user_pref("dom.disable_window_move_resize", true); //NOTICEABLE
 ...
 * [SETTING] to add site exceptions: Ctrl+I>Permissions>Override Keyboard Shortcuts ***/
   // user_pref("permissions.default.shortcuts", 2); //UNCERTAIN
/* 2616: remove special permissions for certain mozilla domains [FF35+]
 * [1] resource://app/defaults/permissions ***/
user_pref("permissions.manager.defaultsUrl", ""); //IMPORTANT
 ...
 * [1] https://bugzilla.mozilla.org/1671182 ***/
   // user_pref("privacy.clearsitedata.cache.enabled", true); //IMPORTANT
...
user_pref("privacy.clearOnShutdown.offlineApps", true); // [DEFAULT: false] //UNCERTAIN
user_pref("privacy.clearOnShutdown.cookies", true); //EDITED DEFAULT_VALUE=true
user_pref("privacy.clearOnShutdown.siteSettings", true); // [DEFAULT: false] //UNCERTAIN
...
user_pref("privacy.cpd.cookies", true); //EDITED DEFAULT_VALUE=FALSE
user_pref("privacy.cpd.downloads", true); // not used, see note above //EDITED UNCOMMENTED
user_pref("privacy.cpd.passwords", true); // [DEFAULT: false] not listed //EDITED UNCOMMENTED
user_pref("privacy.cpd.siteSettings", false); // [DEFAULT: false] //EDITED UNCOMMENTED
...
user_pref("privacy.resistFingerprinting.letterboxing", true); // [HIDDEN PREF] //IMPORTANT
...
user_pref("browser.link.open_newwindow", 3); // [DEFAULT: 3] //IMPORTANT
/* 4513: set all open window methods to abide by "browser.link.open_newwindow" (4512)
 * [1] https://searchfox.org/mozilla-central/source/dom/tests/browser/browser_test_new_window_from_content.js ***/
user_pref("browser.link.open_newwindow.restriction", 0);
/* 4520: disable WebGL (Web Graphics Library)
 * [SETUP-WEB] If you need it then override it. RFP still randomizes canvas for naive scripts ***/
user_pref("webgl.disabled", true); //IMPORTANT
...
user_pref("signon.rememberSignons", false); //EDITED UNCOMMENTED  NOTICEABLE
...
user_pref("browser.sessionstore.resume_from_crash", false); //EDITED UNCOMMENTED/UNCERTAIN IMPORTANT 
 ...
 * [SETTING] Privacy & Security>Address Bar>When using the address bar, suggest ***/
    // user_pref("browser.urlbar.suggest.history", false); //UNCERTAIN IMPORTANT
user_pref("browser.urlbar.suggest.bookmark", false); //EDITED UNCOMMENTED
user_pref("browser.urlbar.suggest.openpage", false); //EDITED UNCOMMENTED
user_pref("browser.urlbar.suggest.topsites", false); // [FF78+] //EDITED UNCOMMENTED
...
user_pref("places.history.enabled", false); //EDITED UNCOMMENTED
...
user_pref("browser.taskbar.previews.enable", false); // [DEFAULT: false] //EDITED UNCOMMENTED
...
user_pref("javascript.options.asmjs", false); //EDITED UNCOMMENTED
/* 5505: disable Ion and baseline JIT to harden against JS exploits
 * [NOTE] When both Ion and JIT are disabled, and trustedprincipals
 * is enabled, then Ion can still be used by extensions (1599226)
 * [1] https://cve.mitre.org/cgi-bin/cvekey.cgi?keyword=firefox+jit
 * [2] https://microsoftedge.github.io/edgevr/posts/Super-Duper-Secure-Mode/ ***/
user_pref("javascript.options.ion", false); //EDITED UNCOMMENTED
user_pref("javascript.options.baselinejit", false); //EDITED UNCOMMENTED
...
user_pref("javascript.options.wasm", false); //EDITED UNCOMMENTED IMPORTANT 
...
user_pref("browser.startup.homepage_override.mstone", "ignore"); // master switch //EDITED COMMENTED
...
/* UPDATES ***/
user_pref("app.update.auto", false); // [NON-WINDOWS] disable auto app updates //EDITED UNCOMMENTED
      // [NOTE] You will still get prompts to update, and should do so in a timely manner
      // [SETTING] General>Firefox Updates>Check for updates but let you choose to install them
user_pref("browser.search.update", false); // disable search engine updates (e.g. OpenSearch) //EDITED UNCOMMENTED
...
user_pref("ui.systemUsesDarkTheme", 1); // [FF67+] [HIDDEN PREF] //EDITED UNCOMMENTED
...
/* UX FEATURES ***/
   // user_pref("browser.messaging-system.whatsNewPanel.enabled", false); // What's New toolbar icon [FF69+] //EDITED COMMENTED
user_pref("extensions.pocket.enabled", false); // Pocket Account [FF46+] //EDITED UNCOMMENTED
   // user_pref("extensions.screenshots.disabled", true); // [FF55+]
user_pref("identity.fxaccounts.enabled", false); // Firefox Accounts & Sync [FF60+] [RESTART] //EDITED UNCOMMENTED
...
/*** [SECTION 10000]: MY_PERSONAL_PREFS ***/
    // Add mulvad as your default/custom dns resolver
user_pref("network.trr.uri", "https://doh.mullvad.net/dns-query"); //Other DNS options:(https://dns-unfiltered.adguard.com/dns-query, https://dns.quad9.net/dns-query, https://dns.nextdns.io/243167, https://freedns.controld.com/p0
)
    // Enable ECH (Encrypted Cliente Hello) for encrypted CH DNS messages
